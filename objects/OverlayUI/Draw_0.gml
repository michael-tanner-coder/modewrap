...
if (global.intro) {
    ...
    var _text_x =
        ...
        sprite_get_width(spr_game_over) / 2 -
        8;
    var _text_y =
...
if (global.game_over) {
    ...
    draw_set_color(c_white);
    drawText(_text_x + 48, _text_y + 27, string(score), 1, c_black);
}
...
if (global.victory) {
    ...
    var _text_x =
        camera_get_view_width(view_camera[0]) / 2 -
        sprite_get_width(spr_victory_text) / 2;
    var _text_y =
        camera_get_view_height(view_camera[0]) / 2 -
        sprite_get_height(spr_victory_text) -
        16;
